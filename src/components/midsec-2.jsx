    ...
    <div className="midcontainer2 h-[100vh] relative mb-[10%] ">
      ...
      <div>
        <img
          src={midllogo2}
          alt=".."
          className="absolute left-[8%] top-[13%] sm:w-0 w-[80%] "
        />

        <div className="absolute left-[8%] top-[25%]  sm:w-[30%] w-[80%] font-extrabold  ">
          <h1 className=" sm:text-[4vw] text-[9vw] ">
            <span className="text-[#00CC99]">Go</span> Smart & Get Organised
          </h1>
        </div>
        <div className="absolute sm:top-[60%] top-[40%] left-[8%] flex flex-col sm:gap-12 gap-5 ">
        ...
        <div className=" absolute flex flex-row sm:top-[101%] top-[80%] left-[8%] sm:gap-11 gap-[40%] sm:w-0 w-[90%]  ">
          <a href="#">
