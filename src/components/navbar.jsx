  ...
  return (
    <div className="w-[83%] sm:h-[104px] h-[10vh] left-[8%] flex  items-center  bg-[#d3d3d3] backdrop-blur-lg bg-opacity-30 rounded-2xl fixed top-5 m-0 z-[1000] ">
      ...
      <div className="flex gap-[18%] sm:w-[50%] w-[100%] relative justify-center items-center sm:mb-[4%] mb-[10%] sm:mr-0 mr-[23%] ">
        <div>
            <button className="sm:w-[20%] w-[20%] sm:h-[50px] h-[5vh] right-[60%] top-[-10%] bg-[#00CC99] rounded-lg flex items-center justify-center gap-2 font-[50px] text-white font-sans text-[1rem] absolute hover:bg-[black] active:scale-90 transition-all nav-btn " onClick={openModal}>
              <img src={play}></img>
               <p>Demo</p>
            </button>
        </div>
